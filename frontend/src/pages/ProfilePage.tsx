    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-purple-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-primary-400 to-purple-500 rounded-full flex items-center justify-center text-white text-3xl font-bold">
        ...
        <div className="space-y-4 max-w-lg mx-auto">
          {profile.links.map((link) => (
            <a
              ...
              className="block w-full py-4 px-6 bg-white hover:bg-gray-50 rounded-xl shadow-sm border border-gray-200 transition-all hover:scale-105 hover:shadow-md"
            >
